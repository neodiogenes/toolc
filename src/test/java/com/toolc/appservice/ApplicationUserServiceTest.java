...
public class ApplicationUserServiceTest {
    ...
    public void setup() {
        ...
        testToken.setType(UserResetToken.Types.RESET.name());
        ...
        Mockito.when(userResetTokenService.create(testUser, UserResetToken.Types.RESET)).thenReturn(testToken);
        Mockito.when(userResetTokenService.findById(testToken.getId())).thenReturn(Optional.of(testToken));
        Mockito.when(userResetTokenService.validateToken(testToken.getId(), UserResetToken.Types.RESET)).thenReturn(Optional.of(testToken));
    ...
    public void testValidateUser() {
        final String newPassword = "foobar1234";
        fail();
...
/*        testUser.setArchived(true);
        ...
        service.validateResetUser(object);
